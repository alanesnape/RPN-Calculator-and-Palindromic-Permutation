...
bool test_02_array_append() {
    ...
    unit_assert(array->data[0] == 100);
    unit_assert(array->data[1] == 101);
    unit_assert(array->data[2] == 102);
    unit_assert(array->data[3] == 103);
    unit_assert(array->data[4] == 104);
    array_delete(array);
    return EXIT_SUCCESS;
}
...
bool test_03_array_at() {
    ...
    array_append(array, 103);
    array_append(array, 104);
    unit_assert(array_at(array, 0) == 100);
    unit_assert(array_at(array, 1) == 101);
    unit_assert(array_at(array, 2) == 102);
    unit_assert(array_at(array, 3) == 103);
    unit_assert(array_at(array, 4) == 104);
    array_delete(array);
    return EXIT_SUCCESS;
}
...
bool test_04_array_index() {
    ...
    array_append(array, 103);
    array_append(array, 104);
    unit_assert(array_index(array, 100) == 0);
    unit_assert(array_index(array, 104) == 4);
    unit_assert(array_index(array, 1000) == -1);
    array_delete(array);
    return EXIT_SUCCESS;
}
...
bool test_05_array_insert() {
    ...
    unit_assert(array->size == 4);
    unit_assert(array->capacity == 4);
    unit_assert(array->data[0] == 1000);
    unit_assert(array->data[1] == 100);
    unit_assert(array->data[2] == 101);
    array_insert(array, 3, 1001);
    unit_assert(array->size == 5);
    unit_assert(array->capacity == 8);
    unit_assert(array->data[3] == 1001);
    unit_assert(array->data[4] == 102);
    array_delete(array);
    return EXIT_SUCCESS;
}
...
bool test_06_array_remove() {
    ...
    unit_assert(array->data[0] == 101);
    unit_assert(array->data[2] == 103);
    array_remove(array, 1);
    unit_assert(array->size == 2);
    unit_assert(array->data[0] == 101);
    unit_assert(array->data[1] == 103);
    array_remove(array, 1);
