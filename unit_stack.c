...
bool test_00_stack_create() {
    ...
    unit_assert(stack->capacity == ARRAY_DEFAULT_CAPACITY);
    unit_assert(stack->size == 0);
    free(stack->data);
    free(stack);
    return EXIT_SUCCESS;
}
...
bool test_02_stack_push() {
    ...
    unit_assert(stack->size == 2);
    unit_assert(stack->data[0] == 100);
    unit_assert(stack->data[1] == 200);
    stack_delete(stack);
    return EXIT_SUCCESS;
}
...
bool test_04_stack_top() {
    Stack *stack = stack_create();
    stack_push(stack, 100);
    unit_assert(stack_top(stack) == 100);
    stack_push(stack, 200);
    unit_assert(stack_top(stack) == 200);
    stack_delete(stack);
    return EXIT_SUCCESS;
}
...
bool test_05_stack_empty() {
    Stack *stack = stack_create();
    unit_assert(stack_empty(stack) == true);
    stack_push(stack, 100);
    unit_assert(stack_empty(stack) == false);
    stack_push(stack, 200);
    stack_pop(stack);
    stack_pop(stack);
    unit_assert(stack_empty(stack) == true);
